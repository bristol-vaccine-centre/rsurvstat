...
- Initial CRAN candidate version with the following functionality
  ...
  - Stratification and filtering by disease (121 options), age group (8
    options), geography (3+1 options)
  - Stratification by disease subtype given parent disease
  - Time varying population denominator inference based on geography and
