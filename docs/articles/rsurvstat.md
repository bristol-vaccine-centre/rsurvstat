...
incidence at NUTS2 level (legend hidden):
...
Matching `sf` maps are supplied as data, that can be joined to the
`SurvStat` output:
...
![](rsurvstat_files/figure-html/unnamed-chunk-6-1.png)
