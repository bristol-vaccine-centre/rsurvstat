...
- Adenovirus (key: Adenovirus (andere Form, Meldepflichtig gemäß
...
- Chickenpox (state) (key: Windpocken (Meldepflicht gemäß
  Landesmeldeverordnung))
...
- Clostridium difficile / mild (key: Clostridium difficile, nicht
  schwerer Verlauf)

- Clostridium difficile / moderate (key: Clostridium difficile, schwerer
  Verlauf)
...
- Enterobacteria colonisation (key: Enterobacteriaceae-Infektion oder
  –Kolonisation)
...
- Haemolytic-uraemic syndrome (key: HUS (Hämolytisch-urämisches
  Syndrom), enteropathisch)

- Haemophilus influenza, invasive (key: Haemophilus influenzae, invasive
  Erkrankung)
...
- Keratoconjunctivitis (IfSG) (key: Keratokunjunktivitis (Meldepflicht
  gemäß IfSG))

- Keratoconjunctivitis (state) (key: Keratokunjunktivitis (Meldepflicht
  gemäß Landesmeldeverordnung))
...
- Pneumococcus (state) (key: Pneumokokken (Meldepflicht gemäß
  Landesverordnung))
...
- Rubella (state) (key: Röteln (Meldepflicht gemäß
  Landesmeldeverordnung))
...
- Subacute Sclerosing Panencephalitis (key: Subakute Sklerosierende
  Panenzephalitis)
...
- Whooping cough (state) (key: Keuchhusten (Meldepflicht gemäß
  Landesmeldeverordnung))
